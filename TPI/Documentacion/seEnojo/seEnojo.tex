...
\begin{document}
	...
	\item $r = min * freq - 1 = 19$
        \item $(n-r) ~= n$
        \item $(j-i) ~= n$
        \item $T_{seEnojo}(n) = c^{\prime\prime\prime}_1 + c^{\prime\prime\prime}_2 + c^{\prime\prime\prime}_3 + c^{\prime\prime\prime}_4 + c^{\prime\prime\prime}_5 * (n-r+1) + c^{\prime\prime\prime}_6 * (n-r) + c^{\prime\prime\prime}_7 * (n-r) + c^{\prime\prime\prime}_8 * (n-r)^{2} * (j-i) + c^{\prime\prime\prime}_9 * (n-r)^{2} * (j-i) + c^{\prime\prime\prime}_10 * (n-r)^{2} + c^{\prime\prime\prime}_11 * (n-r)$
