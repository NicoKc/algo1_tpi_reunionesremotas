...
\begin{document}
    ...
    \begin{minipage}{0.25\textwidth}
        ...
        \begin{tabular}{|c|c}
            ...
            $c^{\prime\prime\prime}_7 \cdot (n-r)               $ &$n - r + 1   $\\
            $c^{\prime\prime\prime}_8 \cdot (n-r) \cdot (j-i)   $ &$n - r       $\\
            $c^{\prime\prime\prime}_9 \cdot (n-r) \cdot (j-i)   $ &$n - r       $\\
            $c^{\prime\prime\prime}_{10} \cdot (n-r)            $ &$n - r       $\\
            $                                                   $ &$            $\\
